...
public class Admin {
    ...
    public Admin(String firstname, String lastname, String email, String gender, String role) {
    ...
    public Admin(String firstname, String lastname, String email, String gender, String role, String policyName, String policyNumber, String policyAddress, String policyCnic, String policyTime) {
        this.firstname = firstname;
        this.lastname = lastname;
        this.email = email;
        this.gender = gender;
    ...
    // Getters and setters in the modified sequence
